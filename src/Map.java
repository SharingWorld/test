...
public class Map extends View implements Constants {
    ...
    Map(PApplet pApplet) {
        ...
        SpriteManager.putImages(pApplet, BLOCKS_IMAGE, "./images/BLOCK.png",
                0, 0, 0, 0, 64, 32, 10);
//        SpriteManager.putImages(pApplet, ITEM_PLAYER, "./images/ITEM_BONUS.png",
//                0,0,0,0,80,
//                44, 8);
//        SpriteManager.putImages(pApplet, ITEM_LASER, "./images/ITEM_BONUS.png",
//                0,0,0,0,80,
//                44, 8);
//        SpriteManager.putImages(pApplet, ITEM_EXTEND, "./images/ITEM_BONUS.png",
//                0,0,0,0,80,
//                44, 8);
//        SpriteManager.putImages(pApplet, ITEM_CLASP, "./images/ITEM_BONUS.png",
//                0,0,0,0,80,
//                44, 8);
//        SpriteManager.putImages(pApplet, ITEM_SLOW, "./images/ITEM_BONUS.png",
//                0,0,0,0,80,
//                44, 8);
//        SpriteManager.putImages(pApplet, ITEM_BONUS, "./images/ITEM_BONUS.png",
//                0,0,0,0,80,
//                44, 8);
//        SpriteManager.putImages(pApplet, ITEM_DOOM, "./images/ITEM_BONUS.png",
//                0,0,0,0,80,
//                44, 8);
